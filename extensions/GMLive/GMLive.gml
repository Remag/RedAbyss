...
// Generated at 2019-10-18 19:24:58 (25789ms) for v1.4.1804+
...
// gml_program_call_v(this:program, name:string, args:GmlValueList, copy:bool = true)->thread
...
#define gml_op_apply
// gml_op_apply(this:int, q:real, v:real)->real
...
// tools__gml_stack_gml_stack_impl__dup(this:array<dynamic>)
var l_this1=argument[0];
if (live_enabled) {
	var l_i=l_this1[0]+1;
	if(l_i>=array_length_1d(l_this1))l_this1[@array_length_1d(l_this1)*2]=0;
...
// tools__gml_stack_gml_stack_impl__dup2(this:array<dynamic>)
var l_this1=argument[0];
if (live_enabled) {
	var l_i=l_this1[0]+2;
	if(l_i>=array_length_1d(l_this1))l_this1[@array_length_1d(l_this1)*2]=0;
...
// tools__gml_stack_gml_stack_impl__dup_in(this:array<dynamic>, z:int)
var l_this1=argument[0];
if (live_enabled) {
	var l_i=l_this1[0];
	var l_v=l_this1[l_i++];
...
// tools__gml_stack_gml_stack_impl__pop(this:array<dynamic>)->T
var l_this1=argument[0];
if (live_enabled) {
	var l_i=l_this1[0];
	var l_r=l_this1[l_i];
...
// tools__gml_stack_gml_stack_impl__discard(this:array<dynamic>)
var l_this1=argument[0];
if (live_enabled) {
	var l_i=l_this1[0];
	l_this1[@l_i]=0;
...
// gml_func_scope_create(actions:GmlActionList, offset:int, args:GmlValueList, locals:GmlValueList, self:any, other:any, next:func_scope)
...
// gml_thread_create(program:program, actions:GmlActionList, args:GmlValueList, locals:GmlValueList, ?self:any, ?other:any, offset:int = 0)
...
// gml_value_list_copy(this:array<any>)->GmlValueList
var l_this1=argument[0];
if (live_enabled) {
